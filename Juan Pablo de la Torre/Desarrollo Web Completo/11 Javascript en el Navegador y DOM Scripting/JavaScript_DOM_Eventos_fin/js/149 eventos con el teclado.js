...
//148 EVENTO CLICK
/*
// Seleccionando elementos y asociándoles un evento
/*const btnEnviar = document.querySelector('.boton--primario'); //esta línea selecciona el botón
btnEnviar.addEventListener('click', function() {
    console.log('enviando formulario');
});

const btnEnviar = document.querySelector('.boton--primario'); //esta línea selecciona el botón
btnEnviar.addEventListener('click', function(evento) { //variable recién creada
    console.log(evento.target); //target nos indica a que elemento se le ha dado clic al ejecutar el evento

    evento.preventDefault(); //preventDefault previene de que un elemento haga su action que tiene por defecto
                             //ejm: verificar que un formulario tenga todos los campos llenos antes de ser enviado

    console.log('enviando formulario');
});*/

//*************************************************************************************************************************
//149 EVENTOS DE LOS INPUTS Y TEXTAREA

const nombre = document.querySelector('#nombre');

/*nombre.addEventListener('change', function(){ //change se ejecuta hasta después de haber terminado el evento anterior
    console.log('escribiendo...');
});*/
//--------------------------------------------------------------------
//Otra forma mejor: para tener una validación en tiempo real
nombre.addEventListener('input', function(){ 
    console.log('escribiendo...');
});
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//Enviando a la consola lo que el usuario está escribiendo en el 'input'
